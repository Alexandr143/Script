...
let lastAmountCredits = 0;

let  input = prompt('How many droits would like you buy ?');
...
if (input === null) {
    ...
    lastAmountCredits = credits - totalPrice;
    console.log(`You bought ${input} droits, on your credit account is lefted ${lastAmountCredits} credits`)
  }
